...
DEEPTAL is provided as free software for research and academic purposes only.

The developers and contributing team shall not be held responsible for any results, interpretations, or consequences arising from the use, misuse, or modification of the source code or outputs generated by the software.

Any alterations made to the original R source code are solely the responsibility of the user.
